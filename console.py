...
class HBNBCommand(cmd.Cmd):
    ...
    Methods:
        ...
        precmd(line): Reformat command line for advanced command syntax.
        postcmd(stop, line): Prints if isatty is false.
        do_quit(command): Method to exit the HBNB console.
        help_quit(): Prints the help documentation for quit.
        do_EOF(arg): Handles EOF to exit program.
        help_EOF(): Prints the help documentation for EOF.
        emptyline(): Overrides the emptyline method of CMD.
        do_create(args): Create an object of any class with given parameters.
        help_create(): Help information for the create method.
        do_show(args): Method to show an individual object.
        help_show(): Help information for the show command.
        do_destroy(args): Destroys a specified object.
        help_destroy(): Help information for the destroy command.
        do_all(args): Shows all objects, or all objects of a class.
        help_all(): Help information for the all command.
        do_count(args): Count current number of class instances.
        help_count(): Help information for the count command.
        do_update(args): Updates a certain object with new info.
        help_update(): Help information for the update command.
    """
